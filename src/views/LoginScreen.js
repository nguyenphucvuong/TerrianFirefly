...
function LoginScreen() {   
  const [request, response, promptAsync] = Google.useAuthRequest({
    expoClientId: '713889504554-n59dd9fqvj97l93aie6710seqnajg9cv.apps.googleusercontent.com',
    androidClientId: '713889504554-hja3akqt7bludpfsdvgldd7nsav2np9c.apps.googleusercontent.com',
    iosClientId: '713889504554-uj322qe5knbs1bpotj0jq0pjr1c3q6pv.apps.googleusercontent.com',
    webClientId: '713889504554-n59dd9fqvj97l93aie6710seqnajg9cv.apps.googleusercontent.com',
  });
  React.useEffect(() => {
    ...
    const clientId = '713889504554-3m9k1n4jtohud708icu3cpkn1srdcder.apps.googleusercontent.com'; // Thay bằng OAuth Client ID của bạn
  ...
  try {
    ...
    return(
        ...
        {errorTextEmail ? <Text style={{ color: 'red' }}>{errorTextName}</Text> : null}
        </View>
        ...
        backgroundColor={'#fff'} colorText={'#000'}
