...
const SettingScreen = () => {
  ...
  const handleLogout = async () => {
    try {
      ...
      Alert.alert(
        "Lỗi",
        "Đã xảy ra lỗi khi thoát đăng nhập. Vui lòng thử lại."
      );
    }
  };
  return (
    <View style={StyleGlobal.container}>
      ...
      <TouchableOpacity
        ...
        onPress={() => navigation.navigate("SetUpAccountScreen")}
      >
      ...
      {user.roleid === 1 ? (
        <View>
          {/* Gạch ngang Admin */}
          <View
            style={{ marginTop: appInfo.heightWindows * 0.02, fontSize: 16 }}
          >
            <Text>Admin</Text>
            <View style={styles.separator} />
          </View>
